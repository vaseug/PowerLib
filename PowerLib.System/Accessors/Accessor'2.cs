...
{
	/// <summary>
	/// Accessor which use two arguments for value access.
	/// </summary>
	/// <typeparam name="A1">First argument type.</typeparam>
	/// <typeparam name="A2">Second argument type.</typeparam>
	/// <typeparam name="T">Value type.</typeparam>
	public class Accessor<A1, A2, T> : IAccessor<A1, A2, T>
	{
		private Func<A1, A2, T> _selector = null;
		private Action<A1, A2, T> _assigner = null;
		...
		public Accessor(Func<A1, A2, T> selector)
			: this(selector, null)
		{
		}
		...
		public Accessor(Action<A1, A2, T> assigner)
			: this(null, assigner)
		{
		}
		...
		/// <param name="selector">Delegate for read value.</param>
		/// <param name="assigner">Delegate for write value.</param>
		public Accessor(Func<A1, A2, T> selector, Action<A1, A2, T> assigner)
		{
			_selector = selector;
			_assigner = assigner ;
		}
