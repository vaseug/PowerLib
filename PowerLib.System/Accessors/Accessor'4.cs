...
{
	/// <summary>
	/// Accessor which use four arguments for value access.
	/// </summary>
	...
	public class Accessor<A1, A2, A3, A4, T> : IAccessor<A1, A2, A3, A4, T>
	{
		private Func<A1, A2, A3, A4, T> _selector = null;
		private Action<A1, A2, A3, A4, T> _assigner = null;
		...
		public Accessor(Func<A1, A2, A3, A4, T> selector)
			: this(selector, null)
		{
		}
		...
		public Accessor(Action<A1, A2, A3, A4, T> assigner)
			: this(null, assigner)
		{
		}
		...
		/// <param name="selector">Delegate for read value.</param>
		/// <param name="assigner">Delegate for write value.</param>
		protected Accessor(Func<A1, A2, A3, A4, T> selector, Action<A1, A2, A3, A4, T> assigner)
		{
			_selector = selector;
			_assigner = assigner ;
		}
