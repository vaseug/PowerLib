...
{
	/// <summary>
	/// Accessor which use ten arguments for value access.
	/// </summary>
	...
	public class Accessor<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, T> : IAccessor<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, T>
	{
		private Func<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, T> _selector = null;
		private Action<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, T> _assigner = null;
		...
		public Accessor(Func<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, T> selector)
			: this(selector, null)
		{
		}
		...
		public Accessor(Action<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, T> assigner)
			: this(null, assigner)
		{
		}
		...
		/// <param name="selector">Delegate for read value.</param>
		/// <param name="assigner">Delegate for write value.</param>
		public Accessor(Func<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, T> selector, Action<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, T> assigner)
		{
			_selector = selector;
			_assigner = assigner ;
		}
		...
		public T this[A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, A9 a9, A10 a10]
		{
			get
			{
				if (_selector == null)
				...
				//
				return _selector(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10);
			}
			set
			{
				if (_assigner == null)
				...
				//
				_assigner (a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, value);
			}
		}
