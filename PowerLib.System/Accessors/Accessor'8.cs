...
{
  /// <summary>
  /// Accessor which use eight arguments for value access.
  /// </summary>
  ...
  public class Accessor<A1, A2, A3, A4, A5, A6, A7, A8, T> : IAccessor<A1, A2, A3, A4, A5, A6, A7, A8, T>
	{
		private Func<A1, A2, A3, A4, A5, A6, A7, A8, T> _selector = null;
		private Action<A1, A2, A3, A4, A5, A6, A7, A8, T> _assigner = null;
		...
		public Accessor(Func<A1, A2, A3, A4, A5, A6, A7, A8, T> selector)
			: this(selector, null)
		{
		}
		...
		public Accessor(Action<A1, A2, A3, A4, A5, A6, A7, A8, T> assigner)
			: this(null, assigner)
		{
		}
		...
		/// <param name="selector">Delegate for read value.</param>
		/// <param name="assigner">Delegate for write value.</param>
		public Accessor(Func<A1, A2, A3, A4, A5, A6, A7, A8, T> selector, Action<A1, A2, A3, A4, A5, A6, A7, A8, T> assigner)
		{
			_selector = selector;
			_assigner = assigner ;
		}
		...
		public T this[A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8]
		{
			get
			{
				if (_selector == null)
				...
				//
				return _selector(a1, a2, a3, a4, a5, a6, a7, a8);
			}
			set
			{
				if (_assigner == null)
				...
				//
				_assigner (a1, a2, a3, a4, a5, a6, a7, a8, value);
			}
		}
