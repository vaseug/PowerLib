...
{
	public struct RegularArrayLongEnumerator<T> : IEnumerator<T>
	{
		...
		public RegularArrayLongEnumerator(Array array)
			: this(array, false, null)
		{
		}

		public RegularArrayLongEnumerator(Array array, bool zeroBased)
			: this(array, zeroBased, null)
		{
		}

		public RegularArrayLongEnumerator(Array array, Func<int> getStamp)
			: this(array, false, getStamp)
		{
		}

		public RegularArrayLongEnumerator(Array array, bool zeroBased, Func<int> getStamp)
		{
			if (array == null)
				throw new ArgumentNullException();
			//
			_arrayIndex = new ArrayLongIndex(new RegularArrayLongInfo (array.GetRegularArrayLongDimensions()));
			_array = array;
			_getStamp = getStamp;
