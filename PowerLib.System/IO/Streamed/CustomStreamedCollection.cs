...
{
  public class CustomStreamedCollection<T> : BaseStreamedCollection<T>
  {
    ...
    public CustomStreamedCollection(Stream stream, SizeEncoding countSizing, SizeEncoding itemSizing, int dataSize,
      ...
      : this(stream, countSizing, itemSizing, dataSize, dataReader, dataWriter, itemEquality, null, leaveOpen, boostAccess, initialize)
    {
    }
