...
{
  public class StoredStreamedCollection<T> : CustomStreamedCollection<T>
  {
    #region Constructors

    public StoredStreamedCollection(Stream stream, SizeEncoding countSizing, SizeEncoding itemSizing, int dataSize,
      Func<Stream, int, T> dataReader, Action<Stream, int, T> dataWriter, Equality<T> itemEquality, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, itemSizing, dataSize, dataReader, dataWriter, itemEquality, null, leaveOpen, boostAccess, true)
    {
    }

    public StoredStreamedCollection(Stream stream, SizeEncoding countSizing, SizeEncoding itemSizing, Func<T, int> dataSizer,
      Func<Stream, int, T> dataReader, Action<Stream, int, T> dataWriter, Equality<T> itemEquality, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, itemSizing, dataSizer, dataReader, dataWriter, itemEquality, null, leaveOpen, boostAccess, true)
    {
    }
    ...
    public StoredStreamedCollection(Stream stream,
      Func<Stream, int, T> dataReader, Action<Stream, int, T> dataWriter, Equality<T> itemEquality, bool leaveOpen, bool boostAccess)
    ...
    public StoredStreamedCollection(Stream stream, Func<T, int> dataSizer,
      Func<Stream, int, T> dataReader, Action<Stream, int, T> dataWriter, Equality<T> itemEquality, bool leaveOpen, bool boostAccess)
    ...
    protected StoredStreamedCollection(Stream stream, CollectionParameter header,
      Func<Stream, int, T> dataReader, Action<Stream, int, T> dataWriter, Equality<T> itemEquality, bool leaveOpen, bool boostAccess)
    ...
    protected StoredStreamedCollection(Stream stream, CollectionParameter header, Func<T, int> dataSizer,
      Func<Stream, int, T> dataReader, Action<Stream, int, T> dataWriter, Equality<T> itemEquality, bool leaveOpen, bool boostAccess)
    ...
    protected StoredStreamedCollection(Stream stream, SizeEncoding countSizing, SizeEncoding itemSizing, int dataSize,
    ...
    protected StoredStreamedCollection(Stream stream, SizeEncoding countSizing, SizeEncoding itemSizing, Func<T, int> dataSizer,
      Func<Stream, int, T> dataReader, Action<Stream, int, T> dataWriter, Equality<T> itemEquality, ICollection<T> coll, bool leaveOpen, bool boostAccess, bool initialize)
