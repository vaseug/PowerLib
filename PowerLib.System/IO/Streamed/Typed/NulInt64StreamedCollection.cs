...
{
  public class NulInt64StreamedCollection : StoredFlaggedStreamedCollection<Int64?, Boolean>
  {
    #region Constructors

    public NulInt64StreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(Int64), compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
          ReadItemFlag, WriteItemFlag, ReadItemData, WriteItemData, NullableEqualityComparer<Int64>.Default.Equals, leaveOpen, boostAccess)
    {
    }

    public NulInt64StreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, ICollection<Int64?> coll, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(Int64), compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
    ...
    public NulInt64StreamedCollection(Stream stream, bool leaveOpen, bool boostAccess)
