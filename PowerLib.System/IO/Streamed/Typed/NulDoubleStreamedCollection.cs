...
{
  public class NulDoubleStreamedCollection : StoredFlaggedStreamedCollection<Double?, Boolean>
  {
    #region Constructors
    ...
    public NulDoubleStreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, ICollection<Double?> coll, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(Double), compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
          ReadItemFlag, WriteItemFlag, ReadItemData, WriteItemData, NullableEqualityComparer<Double>.Default.Equals, coll, leaveOpen, boostAccess)
    {
    }

    public NulDoubleStreamedCollection(Stream stream, bool leaveOpen, bool boostAccess)
