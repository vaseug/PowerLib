...
{
  public class NulComplexStreamedArray : StoredFlaggedStreamedArray<Complex?, Boolean>
  {
    #region Constructors

    public NulComplexStreamedArray(Stream stream, SizeEncoding countSizing, bool compact, ICollection<Complex?> coll, bool leaveOpen, bool boostAccess)
    ...
    public NulComplexStreamedArray(Stream stream, bool leaveOpen, bool boostAccess)
