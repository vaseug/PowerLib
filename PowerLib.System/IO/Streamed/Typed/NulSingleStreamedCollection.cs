...
{
  public class NulSingleStreamedCollection : StoredFlaggedStreamedCollection<Single?, Boolean>
  {
    #region Constructors

    public NulSingleStreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(Single), compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
          ReadItemFlag, WriteItemFlag, ReadItemData, WriteItemData, NullableEqualityComparer<Single>.Default.Equals, leaveOpen, boostAccess)
    {
    }

    public NulSingleStreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, ICollection<Single?> coll, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(Single), compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
    ...
    public NulSingleStreamedCollection(Stream stream, bool leaveOpen, bool boostAccess)
