...
{
  public class NulBooleanStreamedCollection : StoredStreamedCollection<Boolean?>
  {
    #region Constructors

    public NulBooleanStreamedCollection(Stream stream, SizeEncoding countSizing, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(byte), ReadItemData, WriteItemData, NullableEqualityComparer<Boolean>.Default.Equals, leaveOpen, boostAccess)
    {
    }
    ...
    public NulBooleanStreamedCollection(Stream stream, bool leaveOpen, bool boostAccess)
