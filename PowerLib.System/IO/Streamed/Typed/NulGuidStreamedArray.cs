...
{
  public class NulGuidStreamedArray : StoredFlaggedStreamedArray<Guid?, Boolean>
  {
    #region Constructors

    public NulGuidStreamedArray(Stream stream, SizeEncoding countSizing, bool compact, ICollection<Guid?> coll, bool leaveOpen, bool boostAccess)
    ...
    public NulGuidStreamedArray(Stream stream, bool leaveOpen, bool boostAccess)
