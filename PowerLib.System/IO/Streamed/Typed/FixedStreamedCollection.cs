...
{
  public class FixedStreamedCollection : StoredFlaggedStreamedCollection<Byte[], Boolean>
  {
    ...
    public FixedStreamedCollection(Stream stream, SizeEncoding countSizing, SizeEncoding itemSizing, int itemSize, bool compact, bool leaveOpen, bool boostAccess)
    ...
    public FixedStreamedCollection(Stream stream, SizeEncoding countSizing, SizeEncoding itemSizing, int itemSize, bool compact, ICollection<byte[]> coll, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, itemSizing, itemSize, compact, SizeEncoding.B1, sizeof(Byte), v => v != null, f => f,
        ReadItemFlag, WriteItemFlag, ReadItemData, WriteItemData, EqualityComparer.Equals, coll, leaveOpen, boostAccess)
    {
    }

    public FixedStreamedCollection(Stream stream, bool leaveOpen, bool boostAccess)
