...
{
  public class NulRangeStreamedArray : StoredFlaggedStreamedArray<Range?, Boolean>
  {
    #region Constructors

    public NulRangeStreamedArray(Stream stream, SizeEncoding countSizing, bool compact, ICollection<Range?> coll, bool leaveOpen, bool boostAccess)
    ...
    public NulRangeStreamedArray(Stream stream, bool leaveOpen, bool boostAccess)
