...
{
  public class NulInt16StreamedCollection : StoredFlaggedStreamedCollection<Int16?, Boolean>
  {
    #region Constructors

    public NulInt16StreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(Int16), compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
          ReadItemFlag, WriteItemFlag, ReadItemData, WriteItemData, NullableEqualityComparer<Int16>.Default.Equals, leaveOpen, boostAccess)
    {
    }

    public NulInt16StreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, ICollection<Int16?> coll, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(Int16), compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
    ...
    public NulInt16StreamedCollection(Stream stream, bool leaveOpen, bool boostAccess)
