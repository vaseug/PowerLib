...
{
  public class BinaryStreamedArray : StoredFlaggedStreamedArray<Byte[], Boolean>
  {
    ...
    public BinaryStreamedArray(Stream stream, SizeEncoding countSizing, SizeEncoding itemSizing, ICollection<Byte[]> coll, bool leaveOpen, bool boostAccess)
    ...
    public BinaryStreamedArray(Stream stream, bool leaveOpen, bool boostAccess)
      : base(stream, v => v != null ? v.Length : 0, v => v != null, f => f,
          ReadItemFlag, WriteItemFlag, ReadItemData, WriteItemData, EqualityComparer.Equals,
