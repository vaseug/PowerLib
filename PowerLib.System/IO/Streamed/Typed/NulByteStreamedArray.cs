...
{
  public class NulByteStreamedArray : StoredFlaggedStreamedArray<Byte?, Boolean>
  {
    #region Constructors

    public NulByteStreamedArray(Stream stream, SizeEncoding countSizing, bool compact, ICollection<Byte?> coll, bool leaveOpen, bool boostAccess)
    ...
    public NulByteStreamedArray(Stream stream, bool leaveOpen, bool boostAccess)
