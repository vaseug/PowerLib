...
{
  public class BinaryStreamedRegularArray : StoredFlaggedStreamedRegularArray<Byte[], Boolean>
  {
    ...
    public BinaryStreamedRegularArray(Stream stream, SizeEncoding countSizing, SizeEncoding itemSizing, Array array, bool leaveOpen, bool boostAccess)
    ...
    public BinaryStreamedRegularArray(Stream stream, SizeEncoding countSizing, SizeEncoding itemSizing, int[] lengths, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, itemSizing, v => v != null ? v.Length : 0, SizeEncoding.B1, sizeof(Byte), v => v != null, f => f,
    ...
    public BinaryStreamedRegularArray(Stream stream, bool leaveOpen, bool boostAccess)
