...
{
  public class NulRangeStreamedCollection : StoredFlaggedStreamedCollection<Range?, Boolean>
  {
    #region Constructors

    public NulRangeStreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(int) * 2, compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
          ReadItemFlag, WriteItemFlag, ReadItemData, WriteItemData, NullableEqualityComparer<Range>.Default.Equals, leaveOpen, boostAccess)
    {
    }
    public NulRangeStreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, ICollection<Range?> coll, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(int) * 2, compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
          ReadItemFlag, WriteItemFlag, ReadItemData, WriteItemData, NullableEqualityComparer<Range>.Default.Equals, coll, leaveOpen, boostAccess)
    {
    }

    public NulRangeStreamedCollection(Stream stream, bool leaveOpen, bool boostAccess)
