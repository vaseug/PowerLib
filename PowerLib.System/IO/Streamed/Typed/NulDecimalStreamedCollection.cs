...
{
  public class NulDecimalStreamedCollection : StoredFlaggedStreamedCollection<Decimal?, Boolean>
  {
    #region Constructors

    public NulDecimalStreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, 16, compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
          ReadItemFlag, WriteItemFlag, ReadItemData, WriteItemData, NullableEqualityComparer<Decimal>.Default.Equals, leaveOpen, boostAccess)
    {
    }

    public NulDecimalStreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, ICollection<Decimal?> coll, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, 16, compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
    ...
    public NulDecimalStreamedCollection(Stream stream, bool leaveOpen, bool boostAccess)
