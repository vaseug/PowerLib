...
{
  public class NulDoubleStreamedArray : StoredFlaggedStreamedArray<Double?, Boolean>
  {
    #region Constructors

    public NulDoubleStreamedArray(Stream stream, SizeEncoding countSizing, bool compact, ICollection<Double?> coll, bool leaveOpen, bool boostAccess)
    ...
    public NulDoubleStreamedArray(Stream stream, bool leaveOpen, bool boostAccess)
