...
{
  public class NulLongRangeStreamedCollection : StoredFlaggedStreamedCollection<LongRange?, Boolean>
  {
    #region Constructors

    public NulLongRangeStreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(int) * 2, compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
          ReadItemFlag, WriteItemFlag, ReadItemData, WriteItemData, NullableEqualityComparer<LongRange>.Default.Equals, leaveOpen, boostAccess)
    {
    }
    public NulLongRangeStreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, ICollection<LongRange?> coll, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(int) * 2, compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
    ...
    public NulLongRangeStreamedCollection(Stream stream, bool leaveOpen, bool boostAccess)
