...
{
  public class NulInt32StreamedCollection : StoredFlaggedStreamedCollection<Int32?, Boolean>
  {
    #region Constructors

    public NulInt32StreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(Int32), compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
          ReadItemFlag, WriteItemFlag, ReadItemData, WriteItemData, NullableEqualityComparer<Int32>.Default.Equals, leaveOpen, boostAccess)
    {
    }

    public NulInt32StreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, ICollection<Int32?> coll, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(Int32), compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
    ...
    public NulInt32StreamedCollection(Stream stream, bool leaveOpen, bool boostAccess)
