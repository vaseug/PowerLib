...
{
  public class NulDateTimeStreamedCollection : StoredFlaggedStreamedCollection<DateTime?, Boolean>
  {
    #region Constructors

    public NulDateTimeStreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(Int64), compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
          ReadItemFlag, WriteItemFlag, ReadItemData, WriteItemData, NullableEqualityComparer<DateTime>.Default.Equals, leaveOpen, boostAccess)
    {
    }

    public NulDateTimeStreamedCollection(Stream stream, SizeEncoding countSizing, bool compact, ICollection<DateTime?> coll, bool leaveOpen, bool boostAccess)
      : base(stream, countSizing, SizeEncoding.B1, sizeof(Int64), compact, SizeEncoding.B1, sizeof(Byte), v => v.HasValue, f => f,
    ...
    public NulDateTimeStreamedCollection(Stream stream, bool leaveOpen, bool boostAccess)
