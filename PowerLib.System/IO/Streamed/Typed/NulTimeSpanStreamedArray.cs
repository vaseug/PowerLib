...
{
  public class NulTimeSpanStreamedArray : StoredFlaggedStreamedArray<TimeSpan?, Boolean>
  {
    #region Constructors

    public NulTimeSpanStreamedArray(Stream stream, SizeEncoding countSizing, bool compact, ICollection<TimeSpan?> coll, bool leaveOpen, bool boostAccess)
    ...
    public NulTimeSpanStreamedArray(Stream stream, bool leaveOpen, bool boostAccess)
