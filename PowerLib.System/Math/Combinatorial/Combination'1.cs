...
namespace PowerLib.System.Math.Combinatorial
{
	...
	public sealed class Combination<T> : Combinatorial<T>
	{
		private Combination _enumerator;
		private T[] _elements;

		#region Constructors

		public Combination(T[] elements, int variation)
			: base(elements == null ? 0 : elements.Length, variation)
		{
			if (elements == null)
				throw new ArgumentNullException("elements");
			//
			_enumerator = new Combination(elements.Length, variation);
