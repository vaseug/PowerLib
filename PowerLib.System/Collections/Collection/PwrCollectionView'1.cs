...
{
	public class PwrCollectionView<T> : PwrCollectionViewBase<T>
	{
		...
		public PwrCollectionView(ICollection<T> collection)
			: this(collection, (t, i) => true, coll => coll.Count)
		{
		}

		public PwrCollectionView(ICollection<T> collection, Func<T, int, bool> predicate, Func<ICollection<T>, int> counter)
			: base(collection)
		{
